...
const lessonsData = [
  ...
  // ================= L3 LESSONS (Traveler) =================
  {
    title: 'Khối Thịnh vượng chung Anh (The British Commonwealth) [NEW]',
    levelCode: 'L3',
    englishText: 'The Russian leader, Stalin, is supposed to have asked how many divisions the Pope had. Like the Roman Catholic church, the British Commonwealth does not operate in the realms of realpolitik. It is closer, perhaps, to the world of Lewis Carroll than to that of Bismarck.\n\nAs an idea, the Commonwealth dates from the year of Queen Elizabeth\'s birth, 1926. It was to be an association of autonomous communities within the Empire, unified in one respect only: by their allegiance to the sovereign as the head of state. Even this requirement was dropped in 1949 when India asked to remain a member of the Commonwealth even though, as a newly-independent republic, it had ended its allegiance to the crown. Still, even today, Elizabeth is Queen not only of the United Kingdom, but of 17 other countries as well.\n\nThe Commonwealth has one unifying factor: the Queen as its head. It is noteworthy, if not miraculous, that there has been this continuity, that the monarch of the imperialist nation should be accepted with affection and respect by the newly independent sovereign states. The reason lies in the status the Commonwealth offers, and in the framework it provides for useful work to be done. It is remarkable, for example, that all Commonwealth countries, without exception, gave Britain moral support during the Falklands crisis.\n\nThe Commonwealth has seen much disunity as well, and a number of countries have ceased to be members, usually for political reasons. In 1948, Palestine became Israel. In 1949, the Republic of Ireland, neutral during the 39-45 war, also left. In 1972, after war with India, and the creation of Bangladesh, Pakistan also departed. But the most significant departure has been that of South Africa, in 1961.\n\nThe key issue of the Commonwealth is, of course, race, and in particular hostility to racism as practised by white people. For the past 15 years the focus of attention has been upon South Africa, especially upon the severing of sporting links with that country. The refusal of the former Thatcher government to impose economic sanctions on the apartheid-ridden country has caused tension not only between Britain and other Commonwealth countries, but also between the Queen and her Prime Minister.\n\nThe Queen has to remain above all the issues, all the arguments. That she does so is one of the wonders of modern politics. The very looseness of the Commonwealth may be its greatest virtue, given the number of one-party states, military dictatorships, and personal regimes within it. Each member takes or gives what the realpolitik of its own government requires. Through the Commonwealth, for example, Canada has attained a degree of influence among Third World countries which otherwise would never have been possible. But the Commonwealth is also limited: for military help in a domestic crisis, Grenada had to turn to the United States.\n\nStill, Alice in Wonderland or not, a two-metre high portrait of the Queen does hang outside the entrance to Zimbabwe\'s Senate. An official explained: She\'s not there because we love the royal family, but because she is the head of the Commonwealth.',
    vietnameseText: 'Nhà lãnh đạo Nga, Stalin, được cho là đã hỏi Giáo hoàng có bao nhiêu sư đoàn. Giống như Giáo hội Công giáo La Mã, Khối Thịnh vượng chung Anh không hoạt động trong các lĩnh vực của chính trị thực tế. Nó có lẽ gần gũi với thế giới của Lewis Carroll hơn là của Bismarck.\n\nVề mặt ý tưởng, Khối Thịnh vượng chung có từ năm sinh của Nữ hoàng Elizabeth, 1926. Đó được coi là một liên minh của các cộng đồng tự trị trong lòng Đế quốc, chỉ thống nhất ở một khía cạnh duy nhất: lòng trung thành của họ đối với quốc vương với tư cách là người đứng đầu nhà nước. Thậm chí yêu cầu này đã được bãi bỏ vào năm 1949 khi Ấn Độ yêu cầu tiếp tục là thành viên của Khối Thịnh vượng chung mặc dù, với tư cách là một cộng hòa mới độc lập, nước này đã chấm dứt lòng trung thành với vương miện. Tuy vậy, cho đến tận ngày nay, Elizabeth không chỉ là Nữ hoàng của Vương quốc Anh mà còn của 17 quốc gia khác.\n\nKhối Thịnh vượng chung có một nhân tố thống nhất: Nữ hoàng là người đứng đầu. Thật đáng chú ý, nếu không muốn nói là một phép màu, khi có được sự liên tục này, việc quốc vương của quốc gia đế quốc lại được các quốc gia độc lập mới chấp nhận với tình cảm quý mến và sự tôn trọng. Lý do nằm ở vị thế mà Khối Thịnh vượng chung mang lại, và ở khuôn khổ mà nó cung cấp để thực hiện những công việc hữu ích. Ví dụ, thật đáng chú ý là tất cả các nước thuộc Khối Thịnh vượng chung, không có ngoại lệ, đã dành cho Anh sự ủng hộ tinh thần trong cuộc khủng hoảng Falklands.\n\nKhối Thịnh vượng chung cũng chứng kiến nhiều sự chia rẽ, và một số quốc gia đã ngừng làm thành viên, thường là vì lý do chính trị. Năm 1948, Palestine trở thành Israel. Năm 1949, Cộng hòa Ireland, nước trung lập trong cuộc chiến tranh 39-45, cũng rời đi. Năm 1972, sau chiến tranh với Ấn Độ và sự thành lập của Bangladesh, Pakistan cũng rời khỏi. Nhưng sự ra đi đáng chú ý nhất là của Nam Phi vào năm 1961.\n\nVấn đề then chốt của Khối Thịnh vượng chung tất nhiên là chủng tộc, và đặc biệt là sự thù địch đối với phân biệt chủng tộc do người da trắng thực hiện. Trong 15 năm qua, trọng tâm của sự chú ý là vào Nam Phi, đặc biệt là việc cắt đứt các mối liên kết thể thao với quốc gia đó. Sự từ chối của chính phủ Thatcher trước đây trong việc áp đặt các biện pháp trừng phạt kinh tế đối với quốc gia bị phân biệt chủng tộc nặng nề đã gây ra căng thẳng không chỉ giữa Anh và các nước thuộc Khối Thịnh vượng chung khác, mà còn giữa Nữ hoàng và Thủ tướng của bà.\n\nNữ hoàng phải đứng trên tất cả các vấn đề, mọi cuộc tranh luận. Việc bà làm như vậy là một trong những kỳ quan của nền chính trị hiện đại. Chính sự lỏng lẻo của Khối Thịnh vượng chung có thể là đức tính lớn nhất của nó, xét về số lượng các quốc gia độc đảng, chế độ độc tài quân sự và các chế độ cá nhân trong đó. Mỗi thành viên nhận hoặc cho những gì mà chính trị thực tế của chính phủ họ yêu cầu. Ví dụ, thông qua Khối Thịnh vượng chung, Canada đã đạt được một mức độ ảnh hưởng nhất định đối với các nước Thế giới thứ ba, điều mà nếu không thì sẽ không bao giờ có thể thực hiện được. Nhưng Khối Thịnh vượng chung cũng có giới hạn: để được trợ giúp quân sự trong một cuộc khủng hoảng trong nước, Grenada đã phải tìm đến Hoa Kỳ.\n\nTuy nhiên, dù có giống như trong Alice ở Xứ sở Thần tiên hay không, một bức chân dung cao hai mét của Nữ hoàng vẫn được treo bên ngoài lối vào Thượng viện Zimbabwe. Một quan chức giải thích: "Bà ấy không ở đó vì chúng tôi yêu hoàng gia, mà vì bà ấy là người đứng đầu Khối Thịnh vượng chung."',
    keywordsEn: ['Stalin', 'Pope', 'Commonwealth', 'realpolitik', 'sovereign', 'allegiance', 'apartheid', 'sanctions', 'dictatorships', 'Third World'],
    keywordsVi: ['Stalin', 'Giáo hoàng', 'Khối Thịnh vượng chung', 'chính trị thực tế', 'quốc vương', 'lòng trung thành', 'phân biệt chủng tộc', 'biện pháp trừng phạt', 'độc tài', 'Thế giới thứ ba'],
    vocabulary: [
      { word: 'realpolitik', ipa: '/reɪˈɑːl.poʊ.lɪ.tiːk/', meaning: 'chính trị thực tế (chính trị dựa trên lợi ích thực tế hơn là đạo đức hay ý thức hệ)', example: 'The government acted out of realpolitik rather than ideological principles.' },
      { word: 'allegiance', ipa: '/əˈliː.dʒəns/', meaning: 'lòng trung thành, bổn phận của công dân đối với đất nước/quốc vương', example: 'They pledged allegiance to the new sovereign.' },
      { word: 'sovereign', ipa: '/ˈsɑːv.rən/', meaning: 'quốc vương, người trị vì; tối cao', example: 'The Queen is the sovereign of the United Kingdom.' },
      { word: 'apartheid', ipa: '/əˈpɑːr.taɪt/', meaning: 'chế độ phân biệt chủng tộc (từng áp dụng ở Nam Phi)', example: 'The country was struggling under apartheid.' },
      { word: 'sanctions', ipa: '/ˈsæŋk.ʃənz/', meaning: 'các biện pháp trừng phạt (kinh tế/chính trị)', example: 'The UN imposed economic sanctions on the country.' }
    ],
    grammar: [
      { structure: 'not only A... but (also) B...', explanation: 'Cấu trúc "không những... mà còn..." dùng để liên kết hai vế tương đương nhằm nhấn mạnh.', example: 'Elizabeth is Queen not only of the United Kingdom, but of 17 other countries as well.' },
      { structure: 'be supposed to + Verb', explanation: 'Được cho là, có nhiệm vụ phải làm gì hoặc được tin là làm gì.', example: 'Stalin is supposed to have asked how many divisions the Pope had.' }
    ]
  },
  {
